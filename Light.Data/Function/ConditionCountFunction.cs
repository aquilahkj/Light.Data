...
namespace Light.Data
{
	class ConditionCountFunction : AggregateFunction
	{
		...
		internal override string CreateSqlString (CommandFactory factory, bool fullFieldName, out DataParameter [] dataParameters)
		{
			...
			string sql = factory.CreateConditionCountSql (expressionString, !Object.Equals (this._fieldinfo, null) ? _fieldinfo.CreateDataFieldSql (factory, fullFieldName, out dataParameters2) : null, _isDistinct);
