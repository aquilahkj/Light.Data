...
namespace Light.Data
{
    class OracleCommandFactory : CommandFactory
    {
        ...
        public override string CreateAvgSql(string fieldName, bool isDistinct)
        {
            ...
            return AddRound(sql);
            //return string.Format("round(avg({1}{0}),5)", CreateDataFieldSql(fieldName), isDistinct ? "distinct " : "");
        }
        ...
        public override string CreateConditionAvgSql(string expressionSql, string fieldName, bool isDistinct)
        {
            ...
            return AddRound(sql);
            //return string.Format("round(avg({2}case when {0} then {1} else 0 end),5)", expressionSql, CreateDataFieldSql(fieldName), isDistinct ? "distinct " : "");
        }
        ...
        //public override string CreatePlusSql(string field, object value)
        //{
        //    field = ClearRound(field);
        //    field = base.CreatePlusSql(field, value);
        //    return AddRound(field);
        //    //return string.Format("round({0}+{1},{2})", field, value, _roundScale);
        //}

        //public override string CreateMinusSql(string field, object value)
        //{
        //    field = ClearRound(field);
        //    field = base.CreateMinusSql(field, value);
        //    return AddRound(field);
        //    //return string.Format("round({0}-{1},{2})", field, value, _roundScale);
        //}

        //public override string CreateMultiplySql(string field, object value)
        //{
        //    field = ClearRound(field);
        //    field = base.CreateMultiplySql(field, value);
        //    return AddRound(field);
        //    //return string.Format("round({0}*{1},{2})", field, value, _roundScale);
        //}
        ...
        public override string CreateModSql(string field, object value)
        {
            ...
            return AddRound(field);
            //return string.Format("round(mod({0},{1}),{2})", field, value, _roundScale);
        }
        ...
        public override string CreatePowerSql(string field, object value)
        {
            ...
            return AddRound(field);
            //return string.Format("round(power({0},{1}),{2})", field, value, _roundScale);
        }
        ...
        public override string CreateAbsSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(abs({0}),{1})", field, _roundScale);
        }
        ...
        public override string CreateLogSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(ln({0}),{1})", field, _roundScale);
        }
        ...
        public override string CreateExpSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(exp({0}),{1})", field, _roundScale);
        }
        ...
        public override string CreateSinSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(sin({0}),{1})", field, _roundScale);
        }
        ...
        public override string CreateCosSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(cos({0}),{1})", field, _roundScale);
        }
        ...
        public override string CreateTanSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(tan({0}),{1})", field, _roundScale);
        }
        ...
        public override string CreateAtanSql(string field)
        {
            ...
            return AddRound(field);
            //return string.Format("round(atan({0}),{1})", field, _roundScale);
        }
    }
}
