...
namespace Light.Data
{
    ...
    public class AggregateHavingExpression : Expression
    {
        ...
        protected virtual bool EqualsDetail(AggregateHavingExpression expression)
        {
            ...
            {
                AggregateHavingExpression target = expression as AggregateHavingExpression;
        ...
        //        {
        //            if (objType == typeof(AggregateHavingExpression))
        //            {
        //                AggregateHavingExpression target = obj as AggregateHavingExpression;
        //                return Object.Equals(this._expression1, target._expression1) && Object.Equals(this._expression2, target._expression2) && this._operatorType == target._operatorType;
        //            }
        //            else
        //            {
        //                return true;
        ...
        //{
        //    return _expression1.GetHashCode() ^ _expression2.GetHashCode() ^ _operatorType.GetHashCode();
        //}
    }
}
