...
namespace Light.Data.Expressions
{
    class BetweenParamsAggregateExpression : AggregateHavingExpression
    {
        ...
        //    else
        //    {
        //        BetweenParamsAggregateExpression target = obj as BetweenParamsAggregateExpression;
        ...
        //{
        //    return _function.GetHashCode() ^ _isNot.GetHashCode() ^ _fromValue.GetHashCode() ^ _toValue.GetHashCode();
        //}
    }
}
