...
namespace Light.Data
{
	class BetweenParamsQueryExpression : QueryExpression
	{
		...
		{
			string fromParam = state.AddDataParameter (_fieldInfo.ToParameter (_fromValue));
			string toParam = state.AddDataParameter (_fieldInfo.ToParameter (_toValue));
			string functionSql = _fieldInfo.CreateSqlString (factory, isFullName, state);
