...
namespace Light.Data
{
	class SingleParamQueryExpression : QueryExpression
	{
		...
		//	string sql = factory.CreateSingleParamSql (_fieldInfo.CreateSqlString (factory, isFullName, out dataParameters2), _predicate, _isReverse, dataParameter.ParameterName);
		...
		internal override string CreateSqlString (CommandFactory factory, bool isFullName, CreateSqlState state)
		{
			...
			string sql = factory.CreateSingleParamSql (_fieldInfo.CreateSqlString (factory, isFullName, state), _predicate, _isReverse, pn);
