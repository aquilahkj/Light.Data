...
namespace Light.Data
{
    static class Utility
    {
        ...
        public static bool EnumableObjectEquals(object value1, object value2)
        {
            ...
            Type objType = value1.GetType();
            if (value1.GetType() == objType)
            {
                if (value1 is System.Collections.IEnumerable && value1.GetType() != typeof(string))
                {
                    System.Collections.IEnumerator e1 = ((System.Collections.IEnumerable)value1).GetEnumerator();
                    System.Collections.IEnumerator e2 = ((System.Collections.IEnumerable)value2).GetEnumerator(); ;
