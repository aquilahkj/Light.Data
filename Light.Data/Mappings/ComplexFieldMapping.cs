...
{
//	class Old_ComplexFieldMapping : DataFieldMapping//, IFieldCollection
//	{
//		public Old_ComplexFieldMapping (Type type, string fieldName, string indexName, DataMapping mapping, bool isNullable)
