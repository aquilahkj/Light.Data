...
namespace Light.Data
{
	class ConditionSumFunction : AggregateData
	{
		...
		internal override string CreateSqlString (CommandFactory factory, bool isFullName, out DataParameter [] dataParameters)
		{
			...
			string sql = factory.CreateConditionSumSql (expressionString, !Object.Equals (this._fieldinfo, null) ? _fieldinfo.CreateDataFieldSql (factory, isFullName, out dataParameters2) : null, _isDistinct);
