...
{
	[TestFixture ()]
	public class TT_ConfigMappingTest : BaseTest
	{
		[Test ()]
		...
		//	listAgg = context.Query<TeUser> ().GroupBy (x => new LevelIdAggConfig {
		//		LevelId = x.LevelId,
		//		Data = Function.Count ()
		//	}).ToList ();
		...
		//	list = context.Query<TeUser> ().ToList ();
		//	listAgg = context.Query<TeUser> ().GroupBy (x => new LevelIdAggConfig1 {
		//		LevelId = x.LevelId,
		//		Data = Function.Count ()
		//	}).ToList (); dict = new Dictionary<int, int> ();
		...
		//	list = context.Query<TeUser> ().ToList ();
		//	listAgg = context.Query<TeUser> ().GroupBy (x => new LevelIdAggConfigA1 {
		//		LevelId = x.LevelId,
		//		Data = Function.Count ()
		//	}).ToList (); dict = new Dictionary<int, int> ();
